...
# Diretórios fixos
SOURCE_DIR="$HOME/GitHub/ClinAgendaBootcamp_Frontend"
DEST_DIR="$HOME/GitHub/BKPs/ClinAgendaBootcamp_Frontend"
...
BACKUP_DIR="$DEST_DIR/backup_ClinAgendaBootcamp_Frontend_$TIMESTAMP"
